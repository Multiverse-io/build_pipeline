defmodule BuildPipeline.PreviousRunResultTest do
  use ExUnit.Case, async: true
  use Mimic
  alias BuildPipeline.Builders.{RunnersBuilder, PreviousRunResultBuilder, ServerSetupBuilder}
  alias BuildPipeline.{Const, PreviousRunResult}
